...
namespace OOP_in_Csharp
{
    ...
    public class Computer : Device
    {
        ...
        public Computer(string name, string make, string age, bool switchOn) : base(name, make)
        {
            //this.Name = name;
            //this.Make = make;
        ...
        /*public virtual void StartComputer()
        {
            ...
            {
                Console.WriteLine("The comp {0} is already start ", this.Ipaddress);
            }
        ...
        public override void ShutDownComputer()
        {
            ...
            {
                Console.WriteLine("The comp {0} is already shut down", this.Name);
            }
        ...
        public static void PingToComputer(List<Computer> network, Computer pingFrom, string pingTo)
        {
            ...
            foreach (Computer comp in network)
            {
                if ((pingTo == comp.Ipaddress) && (comp.SwitchOn == true))
                {
                    found = true;
                    break;
                }
          ...
          public int Find(string ip, List<Computer> network){
                ...
                for(int i=0; i<network.Count; i++){
                    if((network[i].Ipaddress == ip) && (network[i].SwitchOn == true)){
                        j=1;
    ...
    public class Server : Computer
    {
        ...
        public override void StartDevice()
        {
            ...
            //else{
            //    Console.WriteLine("The server {0} is already start ", this.Ipaddress);
            //}
